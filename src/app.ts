...
export class App {
  ...
  configureRouter(config: RouterConfiguration, router: Router): void {
    ...
    config.map([
      ...
      { route: 'create-order/:id?', name: 'create-order', moduleId: PLATFORM.moduleName('./components/CreateOrder/createorder'), title: 'Edit Order' },
      { route: 'order-list', name: 'order-list', moduleId: PLATFORM.moduleName('./components/OrderList/order-list'), title: 'Order List' },
      { route: 'order-view/:id?', name: 'order-view', moduleId: PLATFORM.moduleName('./components/OrderView/order-view'), title: 'Order View' }
    ]);
  }
}
